...
//                DataStructure.officialArrayList.add(official);
//            }
//        }
//    }
//
...
//        int index = random.nextInt(DataStructure.officialArrayList.size()-1);
//        Official official = DataStructure.officialArrayList.get(index);
//        return official;
//    }
//
...
//                case 1:
//                    DataStructure.participantArrayList.clear();
...
//                    if (runGame()){
//                        setGame(gameType);
//                        if (startGame(DataStructure.participantArrayList,game)){
//                            processGame();
//                            setFinalResult(DataStructure.processResultsArrayList,setOfficial());
//                            setPoint(DataStructure.participantArrayList,results);
//                        }
//                    }
//                    break;
//                case 4:
...
//        saveData(DataStructure.resultsArrayList); //save
//        saveData2(DataStructure.participants);
//        System.out.println("Game saved successfully!");
//    }
//
//    public static void loadData(ArrayList resultsArrayList) throws IOException {
...
//    }
//
//    public static void saveData(ArrayList resultsArrayList) throws IOException {
//        try {
...
//                output.write(resultsArrayList.get(i).toString());
//                output.newLine();
//            }
//
//
...
//    }
//
//    public static void saveData2(ArrayList<Participant> participants) throws IOException {
//        try {
//
//
//            FileWriter fw2 = new FileWriter("Athlete.txt");
//            BufferedWriter output2 = new BufferedWriter(fw2);
//
//
//            for (int i = 0; i < DataStructure.participants.size(); i++){
//                output2.write(DataStructure.participants.get(i).toString());
//                output2.newLine();
//            }
//
//            output2.close();
...
//                                DataStructure.participantArrayList.add(athlete);
//                                break;
//                            }else
//                                // bAddParticipant = true && bCheckExist = true && bGameType = false
//                                break;
...
//        displayAthlete(DataStructure.participantArrayList);
//    }
//
...
//        System.out.print("\n\tOlympic Game\t\n=============================\n"
//                        +"\tParticipant List as below: \n");
//        if (DataStructure.participantArrayList.size() !=0){
//            for (int i = 0; i < DataStructure.participantArrayList.size();i++){
//                System.out.println(DataStructure.participantArrayList.get(i).printParticipant());
//            }
//            System.out.println("\nSelect an athlete from above to predict.\nPlease enter athlete ID");
//            do {
//                String athleteID = input.next();
//                for (int i = 0; i < DataStructure.participantArrayList.size();i++) {
//                    bCheckExist = athleteID.equalsIgnoreCase(DataStructure.participantArrayList.get(i).getParticipantID());
//                    if (bCheckExist) {
//                        Athlete athlete = DataStructure.participantArrayList.get(i);
...
//                "*******************************************************/");
//        TimeUnit.SECONDS.sleep(1);
//        for (int i = 0; i < DataStructure.processResultsArrayList.size(); i++) {
//            System.out.println(DataStructure.processResultsArrayList.get(i).toString());
//        }
//    }
//
//    /****************************************************************************************************************
...
//        DataStructure.resultsArrayList.add(results);
//
...
//        if (DataStructure.resultsArrayList.size() != 0){
//            for (int i = 0; i <DataStructure.resultsArrayList.size();i++){
//                System.out.print("\n\tOlympic Game\t\n=============================\n"
//                        +"\tResult from history: \n");
//                System.out.println(DataStructure.resultsArrayList.get(i).toString());
//            }
//        }else {
...
//            for (int i = 0; i < DataStructure.participantArrayList.size(); i++) {
//                if (addingAthlete.equalsIgnoreCase(DataStructure.participantArrayList.get(i).getParticipantID())) {
...
//            DataStructure.processResultsArrayList = processResults.processResultsArrayList(participantArrayList,game);
//            return true;
//        }
//    }
//
